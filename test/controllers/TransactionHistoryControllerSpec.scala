  ...
  "onPageLoad" - {
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        when(mockOrchestrator.getTransactionHistoryForAllYears(using any(), any(), any()))
          .thenReturn(createSuccessAccountResult(transactionHistoryForYears))
        ...
        contentAsString(result) mustEqual view(aSubscription.orgName, transactionHistoryForYears)(using
          request,
