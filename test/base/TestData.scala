...
object TestData {
  ...
  def registeredUserServicePageViewModel(
  ...
  def generateDeregUserServicePageModel(
    ...
    DeregisteredUserServicePageViewModel(
      ...
      deregDate,
      hasVariableReturns,
      if hasSentLastReturn then { Some(emptyReturn) }
      else { None },
      balance,
  ...
  val registeredUserServicePageViewModelForVoluntaryRegistration =
    registeredUserServicePageViewModel1PendingReturns.copy(sdilSubscription = subscription)
  ...
  val allFinancialItems: List[FinancialLineItem] = List(
    financialItemReturnCharge,
    financialItemReturnChargeInterest,
    financialItemCentralAssessment,
    financialItemCentralAssInterest,
    financialItemOfficerAssessment,
    financialItemOfficerAssInterest,
    financialItemPaymentOnAccount,
    financialItemUnknown
  )

  val financialItemsWithNoReturn: List[FinancialLineItem] = List(
    financialItemReturnChargeInterest,
    financialItemCentralAssessment,
    financialItemCentralAssInterest,
    financialItemOfficerAssessment,
