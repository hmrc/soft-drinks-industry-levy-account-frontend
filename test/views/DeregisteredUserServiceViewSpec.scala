              ...
              s" and has a balance of $balance" - {
                ...
                if sentFinalReturn then {
                  ...
                  "should include a section change business activity" - {
                    ...
                    "that has the expected content" in {
                      document
                        .getElementById("changeBusinessActivityP1")
                        .text() mustBe "If you become liable to register for the Soft Drinks Industry Levy, you must register again."
                    }
                ...
                "should include an account balance section" - {
                  ...
                  s"that has the expected content when the balance is $balance" in {
                    val expectedContent = if balance < 0 then {
                      "Your balance is £100.00."
                    } else if balance > 0 && sentFinalReturn then {
